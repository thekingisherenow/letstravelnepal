...
function Single() {
  ...
  const qna = [
    { "Kathmandu to Pokhara": "our guide will pick you from your hotel in Kathmandu and escort to tourist bus station. Drive to Pokhara from Kathmandu takes 7-8 hours and it is 210 km. If you take flight o Pokhara (25 minutes flight). It will cost extra USD 100/person. Stay overnight in hotel." },
    { "Fly to Jomsom and trek to Kagbeni (2800m)": "After a nice breakfast in Pokhara in the hotel; we take an exciting flight to Jomsom that takes 25 minutes from Pokhara. Upon landing we have break for breakfast with tea/coffee if we take early flight. Arrange our bags for porters then trek to Kagbeni (2800 m.). A nice and classic Tibetan like village with typical house and religious monuments. 3-4 hours walk today. Overnight in lodge." },
    { "Trek to Muktinath (3800m)": "Our journey starts with a special permit check and then onwards to the riverbank of Kaligandaki up stream. During the walk we will have scenic picturesque places to stop by and admire. From Kagbeni the path climbs steeply to re-join the direct trail leading to Khingar at 3200m. The trail climbs through a desert landscape untill Jarkot Village. A further climb reaches us to Muktinath." }
  ]
  ...
  return (
    <>
      ...
      {/* //grids  */}
      <div className='grid grid-cols-1  lg:grid-cols-3 lg:max-w-7xl  lg:mx-auto'>
            ...
            <Tab.Group>
              ...
              <Tab.Panels>
                <Tab.Panel className="pl-2 ">
                  <h1 className='text-4xl w-full border-b-2 border-green-700 pl-5 pt-10 pb-6 font-normal'>Jomson Muktinath Trek</h1>
                  ...
                  {/* //Disclosure */}
                  <div className="w-full  border-gray-200 border-2 max-w-4xl mx-auto mt-10 pt-4">
                    <h1 className='text-2xl p-2 mt-4  font-semibold'>Itinerary</h1>
                                  ...
                                  <div >
                                    ...
                                    focus-visible:ring-opacity-75">
                                      ...
                                      <div className='ml-5 p-2'>
                                        ...
                                        <h1 className='text-vlack text-xl font-semibold'>{Object.keys(single)}</h1>
                                      </div>
                                      <ChevronUpIcon
