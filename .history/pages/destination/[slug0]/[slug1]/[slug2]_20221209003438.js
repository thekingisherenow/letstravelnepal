...
import { ChevronUpIcon, CalendarIcon, ChevronDownIcon, ChevronDoubleDownIcon } from '@heroicons/react/20/solid'
  ...
  return (
    ...
    <div className='bg-gray-200 p-2 '>
      ...
      <div className='flex flex-wrap text-black '>
        ...
        <div className=" md:1/3  w-1/2 p-3 m-1 sm:m-4 cursor-pointer text-black  shadow-xl">
          <a className="block relative rounded overflow-hidden">
            <img alt="ecommerce" className=' block'
        ...
        <div className="  md:1/3  w-1/2 p-3 m-1 sm:m-4 cursor-pointer   shadow-xl">
