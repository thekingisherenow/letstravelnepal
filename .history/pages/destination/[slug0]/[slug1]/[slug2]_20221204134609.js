          ...
          <Tab.Group>
            ...
            <Tab.Panels>
              <Tab.Panel className="pl-2 ">
                ...
                {/* /// kaam baki cha yaha. edi iterny ma data chaina bhane.. itenery nai nadekhiyossss. */}
                {(len(destination.accordianobj)>0) && <div className="w-full  border-gray-200 border-2 max-w-4xl mx-auto mt-10 pt-4">
