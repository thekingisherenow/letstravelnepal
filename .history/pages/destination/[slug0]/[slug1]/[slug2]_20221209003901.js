  ...
  return (
    ...
    <div className='bg-gray-200 p-2 '>
      ...
      <div className='flex flex-wrap text-black '>
        ...
        <div className=" lg:w-1/3 sm:w-1/2 w-full -m-1 sm:m-4 cursor-pointer text-black  shadow-xl">
        ...
        <div className="  lg:w-1/3 sm:w-1/2 w-full -m-1 sm:m-4 cursor-pointer   shadow-xl">
