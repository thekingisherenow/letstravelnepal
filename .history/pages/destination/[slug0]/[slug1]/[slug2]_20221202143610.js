...
function Slug({destination}) {
  ...
  return (
    ...
    <div className='relative'>
      ...
      <h1 className='absolute inset-x-0 bottom-8 text-center text-4xl  text-white'>{destination.trekName}</h1>
    </div>
          ...
          <Tab.Group>
            ...
            <Tab.Panels>
              <Tab.Panel className="pl-2 ">
                <h1 className='text-4xl w-full text-black border-b-2 border-green-700 pl-5 pt-10 pb-6 font-normal'>Jomson Muktinath Trek</h1>
                ...
                <div className="w-full  border-gray-200 border-2 max-w-4xl mx-auto mt-10 pt-4">
                  <h1 className='text-2xl p-2 mt-4 ml-2 text-black  font-semibold'>Itinerary</h1>
                ...
                <div className='mt-6'>
                  <h2 className="mb-2 text-lg font-semibold text-gray-900 text-black text-black">
                    Cost includes: </h2>
                ...
                <div className='mt-6'>
                  <h2 className="mb-2 text-xl font-semibold text-gray-900 text-black">
                    Cost excludes: </h2>
