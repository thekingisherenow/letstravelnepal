      ...
      <header className='sticky w-full top-0 z-50 '>
        ...
        className='hidden bg-black text-white lg:flex flex-col lg:flex-row items-center ml-2 space-y-2 py-4 px-0 lg:py-1  w-full   lg:items-center
         lg:justify-center lg:mx-auto  text-md font-medium'>
                ...
                <Link href= "/"><li className='lg:w-20  text-left lg:text-center w-full mx-1  '>Home</li></Link>
          ...
          menuItems.map((link,i)=> {
            ...
            <Link href= "/aboutus"><li className='w-full lg:w-20 text-left lg:text-center mx-1  '>About Us</li></Link>

            <Link href= "/contact"><li className='w-full lg:w-20 text-left lg:text-center mx-1 '>Contact </li></Link>
            </ul>
      </header>
