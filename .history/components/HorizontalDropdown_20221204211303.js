...
function HorizontalDropdown({dropdown , toggleMenu}) {
  ...
  return (
    <>
        ...
        className="relative w-full h-8 lg:w-[500px]  border-b-1 border-gray-100 border  inline-block text-left" >
         ...
         <ChevronRightIcon 
            ...
            >
              ...
              divide-y divide-green-100 overflow-y-scroll lg:overflow-hidden  rounded-md bg-black text-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                <>
