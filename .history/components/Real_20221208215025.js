                ...
                <div className="flex items-start max-w-6xl mx-auto mt-16 relative">
                    ...
                    <Carousel autoPlay infiniteLoop
                        ...
                        renderArrowPrev={(onClickHandler, hasPrev, label) =>
                            hasPrev && (
                                <button className="hidden absolute top-52 p-2 text-gray-800 transition-colors duration-300 border rounded-full rtl:-scale-x-100 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-800 lg:block hover:bg-gray-100">
