      ...
      <header className='sticky w-full top-0 z-50 '>
        ...
        {/* //LOGO */}
          ...
          <div className=' sm:ml-10 md:ml-20 hidden  min-[400px]:inline-block  justify-between items-center lg:border-2  shrink rounded-full shadow-xl'>
            <input type='text' className='flex-grow text-sm text-gray-600 placeholder:truncate  mt-3 placeholder:text-gray-400 shrink pl-2 bg-transparent outline-none ml-3 '
              placeholder='Start exploring Nepal..' />
            <MagnifyingGlassIcon className=' w-10 h-8 hidden min-[500px]:inline-flex   bg-green-400 p-2 rounded-full  text-2xl mx-2 ' />
