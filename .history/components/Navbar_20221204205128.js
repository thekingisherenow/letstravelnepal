      ...
      <header className='sticky w-full top-0 z-50 '>
        ...
        className='hidden bg-black text-white lg:flex flex-col lg:flex-row items-center ml-2 space-y-2 p-4 lg:py-1  w-full lg:space-x-4  lg:items-center
         lg:justify-center lg:mx-auto  text-md font-medium'>
                ...
                <Link href= "/"><li className='lg:w-36  text-left lg:text-center w-full lg:mx-4 '>Home</li></Link>

             
          {
          menuItems.map((link,i)=> {
            return (<li className='w-full lg:w-36  text-left lg:text-center lg:mx-4 ' key={link.tripType}>
            ...
            <Link href= "/aboutus"><li className='w-full lg:w-36 text-left lg:text-center lg:mx-4  '>About Us</li></Link>

            <Link href= "/contact"><li className='w-full lg:w-36 text-left lg:text-center lg:mx-4 '>Contact </li></Link>
            </ul>
      </header>
