  ...
  return (
    <div>
      ...
      className="relative inline-block w-full ">
        <div>
          <Menu.Button className="flex w-full lg:justify-center  justify-start rounded-md bg-black bg-opacity-20 px-0 lg:py-2 py-1 text-md  text-white hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
            {tripType}
