...
function HorizontalDropdown({dropdown , toggleMenu,togglePlusButton,mobileCheck,mobileScreen}) {
  ...
  return (
    <>
        ...
        className="relative h-8 lg:w-[500px]  border-b-1   inline-block text-left" >
         ...
         <ChevronRightIcon 
            ...
            <PlusIcon onClick={()=>togglePlusButton}
             className='lg:hidden absolute right-2 font-bold -top-2 border-l-2 border-gray-600 w-10 h-12  p-2  '/>
              </div>
