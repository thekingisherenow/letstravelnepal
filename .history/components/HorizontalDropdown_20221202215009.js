...
function HorizontalDropdown({dropdown}) {
  ...
  return (
    <>
        ...
        className="relative w-[200px] h-8  inline-block text-left" >
          
              <div onClick={()=>{}}
               className="inline-flex w-[200px] rounded-md  px-4 py-2 text-sm font-medium text-white hover:bg-opacity-80 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
         {dropdown.tripName}
         <ChevronRightIcon 
