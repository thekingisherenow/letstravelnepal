...
function Navbar() {
  ...
  console.log("menu items- tripType",menuItems.tripType)
  console.log("menuItems.dropdowns",menuItems.dropdowns)
    ...
    <>
      <header className='sticky w-full top-0 z-50 '>
        ...
        className='hidden bg-black text-white lg:flex flex-col lg:flex-row items-center ml-2 space-y-2 p-4 lg:p-2  w-full  lg:items-center lg:justify-center lg:mx-auto lg:space-x-1 text-md font-medium'>
          ...
          {
          links.map((link)=> {
            return (<li className='w-full lg:w-3/4 text-left lg:text-center' key={menuItems.tripType}>
              
              <VerticalDropdown as={Fragment}  key={menuItems.tripType} label = {menuItems.tripType} dropdowns= {menuItems.dropdowns}  /> 
            </li>
