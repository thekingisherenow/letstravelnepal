...
function AboutNepal() {
    return (
        <section className='bg-white  w-full'>
            <div className='container p-5 mx-auto grid grid-cols-1 lg:grid-cols-2 '>
                <div className='lg:col-span-1 md:mx-10 '>
                    ...
                    <div className='w-full flex justify-start mx-auto'>
                        <button className=" mt-4 bg-green-500 hover:bg-green-700  text-white font-bold py-2  px-4 rounded-full">Read more.</button>
                    </div>
