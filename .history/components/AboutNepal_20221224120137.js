        ...
        <section className='bg-neutral-300  w-full'>
            <div className='container p-20 mx-auto grid grid-cols-1 lg:grid-cols-2 '>
                <div className='lg:col-span-1 md:mx-10 '>
                    <h1 className='text-black w-full font-semibold text-left mt-4 text-4xl'>Nepal , the Country of Traveler&apos;s Paradise </h1>
                    <div className="flex justify-start mx-auto mt-6">
                        <span className="inline-block w-40 h-1 bg-lime-700 rounded-full"></span>
                        <span className="inline-block w-3 h-1 mx-1 bg-lime-700 rounded-full"></span>
                        <span className="inline-block w-1 h-1 bg-lime-700 rounded-full"></span>
                    </div>
                    ...
                    <div className='w-full flex justify-start mx-auto'>
                        <button className=" mt-4 bg-lime-700 hover:bg-lime-700  text-white font-bold py-2  px-4 rounded-full">Read more.</button>
                    </div>

                </div>

                <div className='lg:col-span-1 mt-12 lg:mt-0 md:mx-10 '>
