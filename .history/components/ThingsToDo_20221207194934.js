                        ...
                        <div className="flex flex-wrap -m-4">
                            <div className="lg:w-1/3 md:w-1/2 p-4 cursor-pointer  w-full">
                                <a className="block relative h-96 md:h-72 rounded overflow-hidden">
                                    ...
                                    <h1 className='absolute text-white bottom-0 text-3xl w-fulltext-center '> Nepal-Trekking - 73 packages</h1>
                                </a>
                            ...
                            <div className="lg:w-1/3 md:w-1/2 p-4 cursor-pointer  w-full">
                                <a className="block relative h-96 md:h-72 rounded overflow-hidden">
                                    ...
                                    <h1 className='absolute text-white bottom-0 text-3xl w-fulltext-center '> Nepal-Trekking</h1>
                                </a>
