      ...
      <header className='sticky w-full top-0 z-50 '>
        ...
        className='hidden bg-black text-white lg:flex flex-col lg:flex-row items-center ml-2 space-y-4 py-4 px-0 lg:py-1  w-full   lg:items-center
         lg:justify-center lg:mx-auto  text-md font-medium'>
                ...
                <Link href= "/"><li className='lg:w-28 lg:py-2  text-left lg:text-center w-full items-center mt-1  lg:mx-0 mx-4  '>Home</li></Link>
          ...
          menuItems.map((link,i)=> {
            ...
            <Link href= "/contact"><li className='w-full lg:py-2 lg:w-28 text-left lg:text-center items-center lg:mx-0 mx-4 '>Contact </li></Link>
            </ul>
      </header>
