        ...
        <section className='w-full'>
            <div className=' h-[1500px] sticky lg:h-95 md:h-[550px] w-full  bg-white mb-10 '>
                ...
                className={styles.backgroundimage}>
                    ...
                    {/* Containers */}
                    <div className="container flex justify-center px-1 py-10 min-[1200px]:ml-28 ">
                        <div className="flex flex-wrap -m-4">
                            <div className="lg:w-1/3 md:w-1/2 p-4mx-auto  cursor-pointer  w-3/4">
                            ...
                            <div className="lg:w-1/3 md:w-1/2 p-4 mx-auto cursor-pointer w-3/4">
                                <a className="block relative h-96 md:h-52 rounded overflow-hidden">
