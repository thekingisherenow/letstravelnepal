  ...
  return (
    <>
      <header className='sticky w-full top-0 z-50 '>
        ...
        {/* menu list */}
        <ul ref={ulRef}
        className='hidden bg-black text-white lg:flex flex-col lg:flex-row items-center ml-2 space-y-2 p-4 lg:p-1  w-full  lg:items-center
         lg:justify-center lg:mx-auto  text-md font-medium'>

                <li className='lg:mr-auto ml-1 text-left lg:text-center w-full'>Home</li>
          ...
          menuItems.map((link,i)=> {
            ...
            <li className='w-full lg:ml-auto text-left lg:text-center'>About Us</li>

            <li className='w-full lg:ml-auto text-left lg:text-center'>Contact </li>
            </ul>
      </header>
