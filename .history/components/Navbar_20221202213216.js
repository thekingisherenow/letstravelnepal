  ...
  return (
    <>
      <header className='sticky w-full top-0 z-50 '>
        ...
        {/* menu list */}
        <ul ref={ulRef}
        className='hidden bg-black text-white lg:flex flex-col lg:flex-row items-center ml-2 space-y-2 p-4 lg:p-1  w-full  lg:items-center lg:justify-center lg:mx-auto lg:space-x-1 text-md font-medium'>
