    ...
    <>
      <header className='sticky w-full top-0 z-50 '>
        ...
        {navMenu? <XMarkIcon  onClick={()=>toggleMenu()} 
          className='flex text-right shrink-0 font-extrabold cursor-pointer  mx-auto justify-end w-12 h-12 text-xl lg:hidden'/> : <Bars3Icon onClick={()=>toggleMenu()} 
          className='flex text-right shrink-0 font-extrabold cursor-pointer  mx-auto justify-end w-12 h-12 text-xl lg:hidden'/>}
