    ...
    return (
        <section>
            <div className='mt-20 container  bg-white relative '>
                {/* Image source */}
                <div className='md:h-[400px] h-[1000px]   brightness-75 w-full '>
                    <Image src="https://iili.io/HCZUeRa.jpg" className='w-full h-20 object-cover object-top object-none' fill />
                </div>
