        ...
        <section className='w-full'>
            <div className=' h-[1500px] sticky lg:h-95 md:h-[850px] lg:h-[550px]  w-full  bg-white mb-10 '>
                ...
                className={styles.backgroundimage}>
                    ...
                    <h1 className="text-2xl font-semibold text-center p-4   text-gray-800 capitalize xl:text-5xl lg:text-4xl dark:text-white">
                        Things To Do
                    </h1>
                        {/* BORDER BELOW TITLE */}
                    ...
                    <div className="container  px-1 py-10 ">
                        <div className="flex flex-wrap justify-center lg:mx-auto -m-4">
                            <div className="lg:w-96 md:w-1/2 p-4 cursor-pointer  w-full">
