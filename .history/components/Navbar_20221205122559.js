        ...
        className='hidden bg-black text-white lg:flex flex-col lg:flex-row items-center ml-2 space-y-2 py-4 px-0 lg:py-1  w-full   lg:items-center
         lg:justify-center lg:mx-auto  text-md font-medium'>
          ...
          menuItems.map((link,i)=> {
            return (<li className='w-full lg:w-36 lg:mx-2 lg:px-0 px-2 mx-4 text-left lg:text-center lg:border-none border-b-2   border-gray-600 items-center' key={link.tripType}>
            ...
            <Link href= "/aboutus"><li className='w-full lg:py-2 lg:w-28 text-left lg:text-center items-center border-b-2   border-gray-600 lg:border-none  lg:px-0 px-4  my-2'>About Us</li></Link>
