  ...
  return (
    <div>
      ...
      className="relative inline-block w-full  ">
        ...
        >
          <Menu.Items static
           className="lg:absolute w-full lg:-right-16 lg:w-[500px]  lg:top-5 mt-2  origin-top-right divide-y divide-gray-100 rounded-md bg-black shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
            {open &&
