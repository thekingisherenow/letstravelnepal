...
function ThingsToDo() {
    ...
    return (
        <section>
            <div className=' h-[750px] sticky lg:h-[200px] md:h-[550px] w-full  bg-white mb-10 '>
                
                <div  style = {{backgroundImage: `url("https://iili.io/HCZUeRa.jpg")` ,backgroundRepeat : "no-repeat", objectFit:"cover",width:"100%",boxSizing:"border-box" }}
                 className='bg-scroll w-full object-fill '>
