...
function ThingsToDo() {
    ...
    return (
        <section className='w-full'>
            <div className=' h-[1500px] sticky  md:h-[810px] lg:h-[500px]   w-full bg-white mb-10 '>
                ...
                className={styles.backgroundimage}>
                    ...
                    {/* Containers */}
                    <div className="container max-w-5xl mx-auto px-1 py-10 ">
                        <div className="flex flex-wrap  justify-center  -m-4">
                            <div className="lg:w-1/3 md:w-1/2 p-4 cursor-pointer  w-full">
                                <a className="block relative h-96 md:h-60 rounded overflow-hidden">
                                    ...
                                    <div className='absolute text-white bottom-3 text-xl  w-full text-center '> 
                                    <span className='font-bold'>Nepal Trekking         </span>
                                    <span> - 73 package(s)        </span>
                                     </div>
                                </a>
                            ...
                            <div className="lg:w-1/3 md:w-1/2 p-4 cursor-pointer  w-full">
                                <a className="block relative h-96 md:h-60 rounded overflow-hidden">
                                    ...
                                    <div className='absolute text-white bottom-3 text-xl  w-full text-center '> 
                                    <span className='font-bold'>Trekking Guide Hire in Nepal.       </span>
                                    <span> -  1 package(s)       </span>
                                    </div>
                                </a>
                            ...
                            <div className="lg:w-1/3 md:w-1/2 p-4 cursor-pointer w-full">
                                <a className="block relative h-96 md:h-60 rounded overflow-hidden">
                                    ...
                                    <div className='absolute text-white bottom-3 text-xl  w-full text-center '> 
                                    <span className='font-bold'>Nepal Tour       </span>
                                    <span> -  4 package(s)        </span>
                                     </div>
                                </a>
