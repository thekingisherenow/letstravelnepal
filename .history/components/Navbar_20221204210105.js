  ...
  return (
    <>
      <header className='sticky w-full top-0 z-50 '>
        ...
        {/* menu list */}
        <ul ref={ulRef}
        className='hidden bg-black text-white lg:flex flex-col lg:flex-row items-center ml-2 space-y-2 py-4 px-0 lg:py-1  w-full lg:space-x-1  lg:items-center
         lg:justify-center lg:mx-auto  text-md font-medium'>
          ...
          menuItems.map((link,i)=> {
            return (<li className='w-full lg:w-56 mx-1  text-left lg:text-center  ' key={link.tripType}>
