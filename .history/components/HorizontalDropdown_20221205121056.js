  ...
  return (
    <>
        ...
        className="relative w-full h-8 lg:w-[500px]  border-b-1   inline-block text-left" >
              ...
              <div 
               className="inline-flex  rounded-md  px-4 py-2 text-sm font-medium text-white hover:bg-opacity-80 focus:outline-none 
         ...
         <ChevronRightIcon 
            ...
            <PlusIcon onClick={()=>togglePlusButton}
             className='lg:hidden absolute -right-0 border-l-2  border-gray-300 top-1 w-8 h-8  '/>
              </div>
