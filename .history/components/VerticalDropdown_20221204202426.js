  ...
  return (
    <div>
      ...
      className="relative inline-block w-full  ">
        ...
        >
          <Menu.Items static
           className="lg:absolute w-full lg:-right-3 lg:w-[300px]  lg:top-8 mt-2  origin-top-right  rounded-md bg-black shadow-lg
                  ...
                  <Menu.Item key={i} >
                    {({ active }) => (
                      ...
                      {/* //// yaha yedi subNames ko value 0 cha bhane chevron ko value nahalne */}
                        ...
                        <HorizontalDropdown dropdown = {dropdown} toggleMenu={toggleMenu} />  : <span className='px-4 truncate'>{dropdown.tripName} </span>} 
