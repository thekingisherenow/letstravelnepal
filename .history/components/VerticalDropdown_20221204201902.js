  ...
  return (
    <div>
      ...
      className="relative inline-block w-full  ">
        <div>
          <Menu.Button className="flex w-full  lg:justify-center  justify-start 
           rounded-md bg-black bg-opacity-20 px-0 lg:py-2 py-1 text-md  text-white hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
            ...
            <ChevronDownIcon 
              className="ml-1 hidden lg:inline-block -mr-1 mt-2 h-3 w-3 text-green-200 divide-y divide-gray-100  hover:text-green-100"
              aria-hidden="true"
            />
        ...
        >
          <Menu.Items static
           className="lg:absolute w-full lg:-right-3 lg:w-[250px]  lg:top-8 mt-2  origin-top-right lg:divide-y lg:divide-gray-100 rounded-md bg-black shadow-lg
