...
function ThingsToDo() {
    ...
    return (
        <section className='w-full'>
            <div className=' h-[1500px] sticky lg:h-95 md:h-[850px] lg:h-[550px]  w-full  bg-white mb-10 '>
                    ...
                    <div className="container  px-1 py-10 ">
                        <div className="flex flex-wrap -m-4">
                            <div className="lg:w-1/3 md:w-1/2 p-4 cursor-pointer  w-full">
                                <a className="block relative h-96 md:h-72 rounded overflow-hidden">
                                    ...
                                    <h1 className='absolute text-white bottom-0 text-3xl right-1/2 text-center '> Nepal-Trekking - 73 packages</h1>
                                </a>
                            ...
                            <div className="lg:w-1/3 md:w-1/2 p-4 cursor-pointer  w-full">
                                <a className="block relative h-96 md:h-72 rounded overflow-hidden">
                                    ...
                                    <h1 className='absolute text-white bottom-0 text-3xl right-1/2 text-center '> Nepal-Trekking</h1>
                                </a>
