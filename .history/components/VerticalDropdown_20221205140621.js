...
// second open refers to the state of the non-static menu items.
  ...
  console.log("mobileCheck in Vertical dropdown",mobileCheck)
  console.log("mobileScreen in Vertical dropdown",mobileScreen)
  ...
  return (
    <>
      ...
      className="relative inline-block w-full  ">
        <div>
          <Menu.Button onClick={()=>setSecondOpen(!secondOpen) && setOpen(!open)}
           ...
           rounded-md bg-black bg-opacity-20 px-0 lg:py-2 py-1 text-md  text-white hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
            ...
            <ChevronDownIcon 
              ...
              aria-hidden="true"
            />
            {secondOpen? <MinusIcon className='lg:hidden absolute right-8 font-bold -top-2 border-l-2 border-gray-600 w-10 h-12  p-2  '/>:
