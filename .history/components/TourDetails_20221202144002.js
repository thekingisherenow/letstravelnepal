        ...
        <div className='p-2'>
            ...
            <div className='bg-black flex-col shadow-xl pl-4 lg:p-6 p-2 rounded-xl mt-5'>
                ...
                <button onClick={() => setShowMore(!showMore)}
                    ...
                    {showMore ?<>
                    <span className='text-xl text-black text-center'>SHOW LESS</span><ChevronDownIcon className='w-5 text-black h-5 font-bold 
                     mt-[6px] text-5xl'/>
                    </> : <><span className='text-xl text-black text-center'>
                        SHOW MORE
                        </span><ChevronUpIcon className='w-5 h-5 text-black mt-[6px] font-bold 
                         text-5xl'/></>
                        }
