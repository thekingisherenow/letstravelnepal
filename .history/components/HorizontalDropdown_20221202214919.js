  ...
  return (
    <>
        ...
        className="relative w-full h-8  inline-block text-left" >
              ...
              <div onClick={()=>{}}
               className="inline-flex w-96 rounded-md  px-4 py-2 text-sm font-medium text-white hover:bg-opacity-80 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
         {dropdown.tripName}
         <ChevronRightIcon 
