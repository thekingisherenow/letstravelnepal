...
function HorizontalDropdown({dropdown}) {
  ...
  let trek1 = "nepal-trekking" 
  let trek2 =  "dolpo-trekking"
  let trek3 = "lower-dolpo-circuit-trek"
  return (
    <>
                      ...
                      className="px-1 py-1 w-full ">
                       ...
                       {({ active }) => (
                        ...
                        href = {{
                          ...
                          query : {slug0 :"nepal-trekking" ,slug1 : "dolpo-trekking",slug2 : "lower-dolpo-circuit-trek" }
                        }}
                        >
                         <div
