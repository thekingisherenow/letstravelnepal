...
function HorizontalDropdown({dropdown}) {
  ...
  console.log("dropdown.tripSubNameLinks",dropdown.tripSubNameLinks)
  return (
    <>
                    ...
                    return ( 
                      ...
                      className="px-1 py-1 w-full ">
                       ...
                       {({ active }) => (
                        ...
                        // href={'${encodeURIComponent(dropdown.tripSubNameLinks[index])}'}
                        href = {dropdown.tripSubNameLink[index]}
                        >
                         <div
