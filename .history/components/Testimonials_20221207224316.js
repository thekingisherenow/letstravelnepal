    ...
    return (
        <section className="bg-white dark:bg-gray-900  ">
            <div className="container px-6 py-10 mx-auto">
                <h1 className="text-3xl font-semibold mt-5 text-center text-gray-800 capitalize xl:text-5xl lg:text-4xl dark:text-white">
                  Client Review
                </h1>
...
We had an excellent time. We only had a short time to try some trekking and this walk was just one night away and a few hours walk each day which suited us perfectly. We had great views of the mountains for both sunrise and sunset. Accomodation was basic but clean and had own (western style) toilet. Pradip was an excellent guide - fun, relaxed and knowledgeable. The walk down through small villages and farmlets…
                        </p>
