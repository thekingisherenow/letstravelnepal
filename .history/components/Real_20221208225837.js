                ...
                <div className="flex items-start max-w-6xl mx-auto mt-16 relative">
                    ...
                    <Carousel autoPlay infiniteLoop
                        ...
                        renderArrowPrev={(onClickHandler, hasPrev, label) =>
                            hasPrev && (
                                <button onClick={onClickHandler}
                                    className=" bg-red-500 absolute top-5 cursor-pointer left-2 border rounded-full 
                        ...
                        renderArrowNext={(onClickHandler, hasNext, label) =>
                            hasNext && (
                                <button onClick={onClickHandler}
                                    className="bg-red-500 absolute top-5 right-2 cursor-pointer border rounded-full 
                                    // lg:block
                                    //   hover:bg-gray-100
                                ">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
