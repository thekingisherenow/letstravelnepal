            ...
            <div className="container px-6 py-10 mx-auto">
                ...
                <div className="flex items-start max-w-6xl mx-auto mt-16 relative">
                    ...
                    <Carousel
                     autoPlay infiniteLoop
                        ...
                        renderArrowPrev={(onClickHandler, hasPrev, label) =>
                            // hasPrev && (
                                <button onClick={onClickHandler}
                                    className=" bg-gray-700 absolute   top-14 left-10 z-10  cursor-pointer  border rounded-full 
                        ...
                        renderArrowNext={(onClickHandler, hasNext, label) =>
                            hasNext && (
                                <button onClick={onClickHandler}
                                    className="bg-gray-700 absolute top-14 z-10 right-2 cursor-pointer border rounded-full 
                                    lg:block  hover:bg-gray-300
                                ">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-9 h-9" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                    ...
                    >
                        ...
                        <div className='max-w-3xl bg-red-400 mx-auto'>
                        <p className="flex items-center text-center text-gray-500 lg:mx-8 container">
   
My third stay in Nepal! The Tamang Heritage Trail was definitely a highlight. Although we did not start this trek from Kathmandu, organized by Pradip WE arrival perfectly, adapting the route to our needs us. We could find on the walk through the villages a lot about the lifestyle of Tamang, scenic, it is beautiful and the Rise recommended to the Taruche. The view of the Himalayas is a dream. The guide-Porter team was very…
                            </p>
