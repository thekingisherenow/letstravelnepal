  ...
  return (
    <>
      <header className='sticky w-full top-0 z-50 '>
        ...
        {/* //LOGO */}
          <div className='flex h-14 w-32 relative mt-1  object-contain cursor-pointer md:ml-20   flex-shrink-0  '>
            <Image className='  '
          ...
          <div className=' sm:ml-10 md:ml-20 hidden  min-[400px]:inline-block  justify-between items-center lg:border-2 py-1 shrink rounded-full shadow-xl'>
