  ...
  return (
    <>
      ...
      className="relative inline-block w-full  ">
        <div>
          <Menu.Button   
          onMouseOver={()=>(mobileCheck ===false)?mobilesetOpen(true) :console.log("hii") } onMouseLeave={()=>(mobileCheck ===false)?setOpen(false):console.log("hii")}
        ...
        >
          ...
          className="lg:absolute w-full lg:-right-24 lg:w-[250px]  lg:top-8 mt-2  origin-top-right  rounded-md bg-black shadow-lg
           ...
           {secondOpen && <div onClick={()=>setSecondOpen(!secondOpen) && setOpen(!open)}>
